    ...
    <body>
            ...
            <div class="admin-content ">
                <div class="am-cf am-padding-top am-padding-left">
                    <div class="am-fl am-cf">
                        <strong class="am-text-primary am-text-lg">小题列表</strong>
                    </div><br/>
                    <hr/>
                </div>
                <div class="am-g">
        ...
        if(suit==''||subject==''||num==''){
            ...
            $(".add").on("click",function(){
                location.href = "exam_handle.php?subject="+subject+"&suit="+suit+"&num="+num;
            });
            request({method:"getExam",subject:subject,suit:suit,num:num,qt:"1",type:"3"},function(d){
        ...
        function edit(id){
            location.href = "exam_handle.php?subject="+subject+"&suit="+suit+"&num="+num+"&id="+id;
        }
        
        function del(id){
            request({method:"delExam",id:id,subject:subject,suit:suit,parent:num},function(d){
                alert("删除成功");
